...
const Facturacion: FC<VenderProps> = ({ error, setSearchQuery, setSearchQueryA }) => {

    const { mayorista, handleSetMayorista } = useContext(CarritoContext);
    ...
    return (
        <>
            <div className="min-w-64 max-w-64 shadow-lg shadow-gray-600 max-md:hidden max-h-dvh bg-purple-200">
                ...
                <div className="flex flex-col p-5 justify-start min-h-[85%] max-h-[85%] relative overflow-y-scroll custom-scrollbar">
                    <div className="flex pt-5">
                        <button className={`p-2 mb-1 w-full bg-purple-300 hover:bg-purple-400 rounded-md ${mayorista ? "bg-purple-500" : "bg-purple-300 hover:bg-purple-400"}`} onClick={handleSetMayorista}>Mayorista</button>
                    </div>
                ...
                <div className="flex justify-center px-5">
                    <button className="p-2 w-full bg-purple-300 hover:bg-purple-400 rounded-md flex justify-around items-center">
                        Código de Barras
                        <Icon icon="material-symbols:barcode-scanner" width="24" height="24" />
                    </button>
                </div>
            </div>
            <div className={`w-full shadow-lg shadow-gray-600 md:hidden duration-500 ${deploy ? "h-60" : "h-32"} overflow-y-scroll custom-scrollbar bg-purple-200`}>
                <div className="flex flex-col p-2 justify-between">
                    ...
                    <div className="flex justify-around mb-2">
                        <button className={`p-2 w-full mr-1 ml-3 bg-purple-300 hover:bg-purple-400 rounded-md ${mayorista && "bg-purple-500 hover:bg-purple-600"}`} onClick={handleSetMayorista}>Mayorista</button>
                        <button className="p-2 w-full ml-1 bg-purple-300 hover:bg-purple-400 rounded-md flex justify-around items-center">
                            Código de Barras
                            <Icon icon="material-symbols:barcode-scanner" width="24" height="24" />
                        </button>
                    </div>
