...
const SideCliente: FC<ClientesProps> = ({ setSearchQuery }) => {
    ...
    return (
        <>
            <div className="min-w-64 max-w-64 shadow-lg shadow-gray-600 max-md:hidden max-h-dvh overflow-y-scroll custom-scrollbar bg-purple-200">
                ...
                <div className="p-5">
                    ...
                    <div className="flex flex-col p-5 justify-between">
                        ...
                        <button
                            className={`p-2 mb-1 w-full bg-purple-300 hover:bg-purple-400 rounded-md ${activeButton === "true" ? "bg-purple-500" : "bg-purple-300 hover:bg-purple-400"}`}
                            onClick={() => handleButtonClick("true")}>
                            Mayoristas
                        </button>
                        <button
                            className={`p-2 mb-1 w-full bg-purple-300 hover:bg-purple-400 rounded-md ${activeButton === "false" ? "bg-purple-500" : "bg-purple-300 hover:bg-purple-400"}`}
            ...
            <div className={`w-full shadow-lg duration-500 ${deploy ? "h-80" : "h-48"} shadow-gray-600 md:hidden overflow-y-scroll custom-scrollbar bg-purple-200`}>
                ...
                <div className="flex flex-col p-5 justify-between">
                    ...
                    <div className={`${deploy ? "" : "hidden"} mt-2`}>
                        ...
                        <button
                            className={` mt-2 p-2 mb-1 w-full bg-purple-300 hover:bg-purple-400 rounded-md ${activeButton === "none" ? "bg-purple-500" : "bg-purple-300 hover:bg-purple-400"}`}
                            onClick={() => handleButtonClick("none")}>
                            Todos
                        </button>
                        <button
            ...
            {showAddCliente && (
                <RegistrarCliente closeComponent={handleAddCliente} key={0} />
            )}
        </>
    )
}

export default SideCliente;