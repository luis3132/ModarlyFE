...
const Inventario: FC<inventarioprops> = ({ categorias, loading, error, setSearchQuery, setSearchQueryA }) => {
    ...
    return (
        <>
            <div className="min-w-56 shadow-lg shadow-gray-600 max-md:hidden max-h-screen overflow-y-scroll custom-scrollbar bg-purple-200">
            ...
            <div className="w-full shadow-lg shadow-gray-600 md:hidden max-h-screen h-min overflow-y-scroll custom-scrollbar bg-purple-200">
