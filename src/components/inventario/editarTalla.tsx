import type { Talla } from "@/lib/types/types";
...
const EditarTalla: FC<TallaProps> = ({ articuloTallas, tallaNueva, borrarTallas, editarTalla }) => {
    ...
    const [tallaEditable, setTallaEditable] = useState<Talla>({
        id: 9999,
        articulo: articuloTallas[0].articulo,
        talla: "",
        cantidad: 0,
        estado: true
    });
            ...
            {edit ? (
                <>
                    <td>
                        <input
                            name="talla"
                            value={tallaEditable.talla}
                            disabled
                            maxLength={5}
                            id="talla"
                            type="text"
                            className="bg-gray-200 h-8 rounded-full text-center w-[80%]"
                            placeholder="M" />
                    </td>
                    <td>
                        <input
                            name="cantidad"
                            value={tallaEditable.cantidad}
                            onChange={(e) => handleTallaChange(e)}
                            maxLength={5}
                            id="cantidad"
                            type="number"
